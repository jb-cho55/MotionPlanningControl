...
% Process the 7 trucks fed in via traffic_info (T01..T07)
for i = 1:7
    idx = (i - 1) * 3;
...
% T00 (IPG_CompanyCar_2018_Blue, static at (76.1, -5), yaw=pi/2) — hardcoded
% because the Subsystem only routes T01..T07 to traffic_info. Modeled with the
% truck footprint to leave a conservative safety margin around it.
t00_px = 76.1;
t00_py = -5.0;
t00_yaw = pi / 2;
c_yaw = cos(t00_yaw);
